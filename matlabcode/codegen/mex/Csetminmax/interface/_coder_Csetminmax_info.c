...
/* Include files */
#include "_coder_Csetminmax_info.h"
...
static void info_helper(const mxArray **info)
{
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[E]C:/Users/Brenton/Downloads/Google Drive/Miscellaneous/IGPP/igpp/matlabcode/Csetminmax.m"),
                "context", 0);
  emlrtAddField(*info, emlrt_marshallOut("disp"), "name", 0);
  emlrtAddField(*info, emlrt_marshallOut("char"), "dominantType", 0);
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXMB]$matlabroot$/toolbox/matlab/lang/disp.m"), "resolved", 0);
  ...
  emlrtAddField(*info, b_emlrt_marshallOut(1303178606U), "fileTimeLo", 1);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/coder/coder/+coder/+internal/scalarEg.p"),
                "resolved", 4);
  emlrtAddField(*info, b_emlrt_marshallOut(1419983828U), "fileTimeLo", 4);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_int_forloop_overflow_check.m"),
                "resolved", 5);
  emlrtAddField(*info, b_emlrt_marshallOut(1400553180U), "fileTimeLo", 5);
  ...
  emlrtAddField(*info, b_emlrt_marshallOut(1346542758U), "fileTimeLo", 6);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/fixedpoint/isnumerictype.m"), "resolved",
                7);
  emlrtAddField(*info, b_emlrt_marshallOut(1398907998U), "fileTimeLo", 7);
  ...
  emlrtAddField(*info, b_emlrt_marshallOut(1362294282U), "fileTimeLo", 8);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_plus.m"),
                "resolved", 12);
  emlrtAddField(*info, b_emlrt_marshallOut(1372614816U), "fileTimeLo", 12);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/shared/coder/coder/+coder/+internal/indexPlus.m"),
                "resolved", 13);
  emlrtAddField(*info, b_emlrt_marshallOut(1372615560U), "fileTimeLo", 13);
...
mxArray *emlrtMexFcnProperties()
{
  ...
  mxSetFieldByNumber(xEntryPoints, 0, 0, mxCreateString("Csetminmax"));
...
/* End of code generation (_coder_Csetminmax_info.c) */
