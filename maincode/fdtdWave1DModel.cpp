...
void acoustic_1Dmodel(int rmax,int zmin,int zmax,float fsrc,int srcz,
					  float Tend); // can be removed by moving function above main
...
int main() {   
   ...
   if (srcalt < zmin || zmax <= srcalt) {         
      printf(" FATAL ERROR \n"); // cout should be favored in c++, more type safe and less error prone
                                 // also extensible when it comes to user defined tpes
      printf(" max alt=%d, srcalt=%d, min alt = %d\n",zmax,srcalt,zmin);
	   printf(" SUGGESTION: fix s.t. zmin <= srcalt < zmax & recompile \n");
      exit(-1);   // with our current logic, return statement might be better since exit 
                  // doesn't call destructors so locally scoped objects stay in file.
                  // This is especially bad for files left open. Return will make sure
                  // they are properly closed even if it iesn't explicity closed. Also exit
                  // requires stdlib.h import.
                  // If we want to keep exit, we should use EXIT_SUCCESS or EXIT_FAILURE
   }  
//.........................................................................   
   switch (dimension) {
      case 1:
...
void acoustic_1Dmodel(int rmax,int zmin,int zmax,float fsrc,int srcz,
   ...
   char infilename[80], ofilename[80], logfilename[80];
	...
	sprintf(logfilename,"RunLogfile.txt");   
   // std::ostringstream logfilename;
   // logfilename << "RunLogfile.txt";
   flogid = fopen(logfilename,"w");
   // c++ version is std::ofstream file(logfilename);
...
//.........................................................................
   ...
   sprintf(ofilename,"outputjztopo.txt"); outputascii(ofilename,jztopo); // this gets called a lot, very repetitive
   sprintf(ofilename,"outputjxtopo.txt"); outputascii(ofilename,jxtopo); // move to a function and inline?
...
//.........................................................................
   ...
   double *Vxacterm = zeros(NZ); double *Vyacterm = zeros(NZ); // std::vector<double> Vxacterm(NZ);
...
//.........................................................................  
   ...
   outputBinary_2d(ofilename,precvrs,NTMAX,dx,dt,zmin);
	...
	fclose(flogid);
   return; // no need for return since void but this is also okay
}
//#########################################################################