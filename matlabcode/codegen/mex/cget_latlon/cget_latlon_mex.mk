...
MAKEFILE = cget_latlon_mex.mk

include cget_latlon_mex.mki
...
MEX_FILE_NAME_WO_EXT = cget_latlon_mex
...
SYS_INCLUDE += -I"$(START_DIR)\codegen\mex\cget_latlon"
SYS_INCLUDE += -I"$(START_DIR)\codegen\mex\cget_latlon\interface"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\cget_latlon/%.c
	$(CC) -Fo"$@" $(CFLAGS) "$<"
