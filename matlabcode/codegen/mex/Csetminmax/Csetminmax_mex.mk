...
MAKEFILE = Csetminmax_mex.mk

include Csetminmax_mex.mki
...
MEX_FILE_NAME_WO_EXT = Csetminmax_mex
...
SYS_INCLUDE += -I"$(START_DIR)\codegen\mex\Csetminmax"
SYS_INCLUDE += -I"$(START_DIR)\codegen\mex\Csetminmax\interface"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\Csetminmax/%.c
	$(CC) -Fo"$@" $(CFLAGS) "$<"
